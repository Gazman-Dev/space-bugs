...
class Bullet:
    def __init__(self, position: Vector2, speed: float = 5, direction: Vector2 = Vector2(0, -1), radius: int = 5, color: tuple[int, int, int] = (255, 0, 0), sound_effect: SoundPlayer = None):
